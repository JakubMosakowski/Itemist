...
public class DynamicListView extends ListView {
    ...
    private void notifyHoverEnded() {
        if (mHoverOperation != null) {
            ...
            mHoverOperation.hoverEnded(DynamicListView.this, mMobileItemId, position, mMobileItemPosition, mHoverCellCurrentBounds, mHoverCellOriginalBounds);
        }
    }
    ...
    private void notifyHoverPosition() {
        ...
        if (mHoverOperation != null) {
            int position = getPositionByPoint(mHoverCellCurrentBounds.centerX(), mHoverCellCurrentBounds.centerY());
            mHoverOperation.hoverPosition(DynamicListView.this, mMobileItemId, position, mMobileItemPosition, mHoverCellCurrentBounds, mHoverCellOriginalBounds);
        }
    }
